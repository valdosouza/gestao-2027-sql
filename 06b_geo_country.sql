-- =====================================================================
-- Setes API — setes-app Fase 1: Seed geo — tb_country
-- Fonte: seed/tb_country.sql (phpMyAdmin dump adaptado)
-- INSERT IGNORE: idempotente. Executar após script 06.
-- =====================================================================

USE `setes_central`;
INSERT IGNORE INTO `tb_country` (`id`, `name`) VALUES
(0, NULL),
(132, 'AFEGANISTAO'),
...
(9970, 'ORGANIZACOES INTERNACIONAI'),
(9971, 'CAZAQUISTÃO');
COMMIT;