-- =====================================================================
-- Seed 36: flag 'orders' RETROATIVA (Pedido de Venda/Conjugado,
-- 2026-08-22).
--
-- Institutions NOVAS ganham 'orders' pelo insertDefaultFlags; este script
-- cobre as CRIADAS ANTES. Idempotente (NOT EXISTS).
-- Executar após script 35.
-- =====================================================================
